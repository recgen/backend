from sqlalchemy import Boolean, Column, Enum, Table
from sqlalchemy.dialects.postgresql import UUID

from health_backend.adapters.persistence.db.common.types import NameType, NonFutureDateType
...
patient_table = Table(
    ...
    Column('birth_date', NonFutureDateType, nullable=False),
